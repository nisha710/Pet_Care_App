...
public class SpecialDietActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        prev_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(SpecialDietActivity.this,CarePlansActivity.class);
        ...
        buy_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Dialog customDialog = new Dialog(SpecialDietActivity.this);
