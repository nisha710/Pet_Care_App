...
public class Cat1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cat=(ImageView) findViewById(R.id.cat1img);
        cost=(TextView) findViewById(R.id.cat1cost);
        name= (TextView) findViewById(R.id.CatFood1);
        addcart=(Button) findViewById(R.id.addcartcat1);
        add=(ImageButton) findViewById(R.id.addcat1);
        sub=(ImageButton) findViewById(R.id.subcat1);
        ...
        prev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Cat1.this,Shop_Activity.class);
                ...
                db.collection("AddToCart")
                        ...
                        .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                            ...
                            public void onSuccess(DocumentReference documentReference) {
                                Toast.makeText(Cat1.this,"Added To Cart",Toast.LENGTH_SHORT).show();
                            }
                        }).addOnFailureListener(new OnFailureListener() {
                            @Override
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(Cat1.this,"Not Added",Toast.LENGTH_SHORT).show();
                            }
                        });
            }
        });
