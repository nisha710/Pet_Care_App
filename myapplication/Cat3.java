...
public class Cat3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cat=(ImageView) findViewById(R.id.cat3img);
        cost=(TextView) findViewById(R.id.cat3cost);
        name= (TextView) findViewById(R.id.CatFood3);
        addcart=(Button) findViewById(R.id.addcartcat3);
        add=(ImageButton) findViewById(R.id.addcat3);
        sub=(ImageButton) findViewById(R.id.subcat3);
        ...
        prev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Cat3.this,Shop_Activity.class);
                ...
                db.collection("AddToCart")
                        ...
                        .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                            ...
                            public void onSuccess(DocumentReference documentReference) {
                                Toast.makeText(Cat3.this,"Added To Cart",Toast.LENGTH_SHORT).show();
                            }
                        }).addOnFailureListener(new OnFailureListener() {
                            @Override
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(Cat3.this,"Not Added",Toast.LENGTH_SHORT).show();
                            }
                        });
