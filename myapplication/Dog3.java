...
public class Dog3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cat=(ImageView) findViewById(R.id.dog3img);
        cost=(TextView) findViewById(R.id.dog3cost);
        name= (TextView) findViewById(R.id.DogFood3);
        addcart=(Button) findViewById(R.id.addcartdog3);
        add=(ImageButton) findViewById(R.id.adddog3);
        sub=(ImageButton) findViewById(R.id.subdog3);
        ...
        prev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Dog3.this,Shop_Activity.class);
                ...
                db.collection("AddToCart")
                        ...
                        .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                            ...
                            public void onSuccess(DocumentReference documentReference) {
                                Toast.makeText(Dog3.this,"Added To Cart",Toast.LENGTH_SHORT).show();
                            }
                        }).addOnFailureListener(new OnFailureListener() {
                            @Override
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(Dog3.this,"Not Added",Toast.LENGTH_SHORT).show();
                            }
                        });
            }
        });
